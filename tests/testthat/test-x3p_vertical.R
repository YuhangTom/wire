test_that("input check works", {
  expect_error(
    x3p_vertical(1:3,
      freqs = c(0, 0.3, 0.7, 1), method = "MLE",
  ...
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.5, 0.7, 1), method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0.1, 0.3, 0.7, 1), method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 0.9), method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = "abc", method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = TRUE, method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = data.frame(1:3, 2:4), method = "MLE",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 1), method = "abc",
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 1), method = 1,
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 1), method = TRUE,
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 1), method = data.frame(1:3, 2:4),
      ntheta = 720, min_score_cut = 0.1, ifplot = FALSE, loess_span = 0.2
    )
  )
  expect_error(
...
test_that("output plot works", {
  ...
  expect_visible(
    x3p_vertical(x3p_inner_impute,
      freqs = c(0, 0.3, 0.7, 1), method = "quantile",
      ntheta = 720, min_score_cut = 0.1, ifplot = TRUE, loess_span = 0.2
    )
  )
})
