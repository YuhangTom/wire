test_that("input check works", {
  expect_error(
    vec_align_sigs_list("abc", shift_sig,
  ...
  expect_error(
    vec_align_sigs_list(TRUE, shift_sig,
      min.overlap = NULL, ifplot = FALSE,
      name1 = "Cut1", name2 = "Cut2", legendname = "Signal",
      titlename = NULL
    )
  ...
  expect_error(
    vec_align_sigs_list(data.frame(1:3, 2:4), shift_sig,
      min.overlap = NULL, ifplot = FALSE,
      name1 = "Cut1", name2 = "Cut2", legendname = "Signal",
      titlename = NULL
    )
  ...
  expect_error(
    vec_align_sigs_list(raw_sig, "abc",
      min.overlap = NULL, ifplot = FALSE,
      name1 = "Cut1", name2 = "Cut2", legendname = "Signal",
      titlename = NULL
    )
  ...
  expect_error(
    vec_align_sigs_list(raw_sig, TRUE,
      min.overlap = NULL, ifplot = FALSE,
      name1 = "Cut1", name2 = "Cut2", legendname = "Signal",
      titlename = NULL
    )
  ...
  expect_error(
    vec_align_sigs_list(raw_sig, data.frame(1:3, 2:4),
      min.overlap = NULL, ifplot = FALSE,
      name1 = "Cut1", name2 = "Cut2", legendname = "Signal",
      titlename = NULL
    )
  ...
  expect_error(
    vec_align_sigs_list(raw_sig, shift_sig,
